	...
	key.addEventListener('click', () => {
		...
		if (value == "clear") {
			...
			if (pipsInput.style.border !== 'none' && input1 === "") {
				...
				switchButton.style.display = 'none';
				display_input1 = "";
				outputDisplay.innerHTML = `To risk <span class="riskAmount">45&nbsp;USD</span> out of <span class="accountBalance">${accountBalance}&nbsp;USD</span> in '${currentAsset}', use a lotsize of <span><strong>1.2</strong></span> .`;
